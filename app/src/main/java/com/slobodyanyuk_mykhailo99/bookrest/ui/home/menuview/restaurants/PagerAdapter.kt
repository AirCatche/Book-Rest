...
class PagerAdapter(fragmentActivity:  FragmentManager, lifecycle: Lifecycle) : FragmentStateAdapter(fragmentActivity,lifecycle) {
    ...
    override fun createFragment(position: Int): Fragment {
        return when(position) {
            0 -> { AllRestaurantsFragment.newInstance() }
